...
#ifndef RIGHTHANDSIDE_RIGHTHANDSIDE_HPP_
#define RIGHTHANDSIDE_RIGHTHANDSIDE_HPP_
...
class RightHandSideConcept {
 public:
  ...
  virtual void PostStage(Field<T>& fldin, real t) = 0;
...
#endif // RIGHTHANDSIDE_RIGHTHANDSIDE_HPP_
