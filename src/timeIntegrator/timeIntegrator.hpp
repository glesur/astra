...
#ifndef TIMEINTEGRATOR_TIMEINTEGRATOR_HPP_
#define TIMEINTEGRATOR_TIMEINTEGRATOR_HPP_
...
class TimeIntegrator {
 public:
  TimeIntegrator(Input &input, Grid *grid, std::vector<std::unique_ptr<RightHandSideConcept<T>>> &rhsVector)
    : grid(grid), logger(input, grid, this) {
...
#endif // TIMEINTEGRATOR_TIMEINTEGRATOR_HPP_
