...
// RK3 time integrator
#ifndef TIMEINTEGRATOR_RK3_HPP_
#define TIMEINTEGRATOR_RK3_HPP_
...
class RK3TimeIntegrator : public TimeIntegrator<T> {
 public:
  RK3TimeIntegrator(Input &input, Grid *grid, std::vector<std::unique_ptr<RightHandSideConcept<T>>> &rhsVector)
    : TimeIntegrator<T>(input,grid,rhsVector),
    dfld("RK3 dfld",grid->npf),
    dfld1("RK3 dfld",grid->npf) {
